...
@patch(
    "project.storage_table.TableServiceClient.get_table_client",
    return_value="table_client",
)
def test_upload_to_table(
    get_connection_string_from_keyvault, TableServiceClient, get_table_client
):
    entity = {}
    assert upload_to_table("table_name", entity) is None
