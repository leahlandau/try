...
def test_build_email_message():
    ...
    assert result == {
        "message": {
            "subject": "Test build email message",
            "body": {"contentType": "Text", "content": "Test build email message"},
            "toRecipients": [{"emailAddress": {"address": "porina3345@ustorp.com"}}],
        }
    }


@patch(
    "project.send_email.base64.b64encode",
    return_value=b"att_file_after_convert_to_base64",
)
...
def test_build_email_message_with_excel(
    b64encode, download_blob_excel, delete_blob_excel
):
    email_recipient = "porina3345@ustorp.com"
    subject = "Test build email message"
    body = "Test build email message"
            ...
            "attachments": [
                {
                    ...
                    "contentBytes": "att_file_after_convert_to_base64",
                }
            ],
        }
    }
